    ...
    <div className="flex flex-col">
      <section>
        <ContentImgSection
          ...
          description="La cérémonie et la réception auront lieu au Château de Laforest. Situé près de Lyon, le chateau offre un environnement parfait pour célébrer notre journée spéciale entourés de nos proches. Cliquez sur le bouton ci-dessous pour voir l'emplacement exact afin de ne pas vous perdre en chemin !"
